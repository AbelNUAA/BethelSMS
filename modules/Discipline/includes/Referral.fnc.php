 ...
 * @since 4.5
 *
 * @global $_BETHEL['ReferralInput'] Contains the HTML code.
 * @deprecated Filter $_BETHEL['ReferralInput'] global. Since 5.4 Use &$input instead.
 *
...
function ReferralInput( $category, $value = '', $new = true )
{
	...
	// @deprecated Filter $_BETHEL['ReferralInput'] global.
	$_BETHEL['ReferralInput'] = $input;
