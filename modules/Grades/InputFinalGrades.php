...
// If running as a teacher program then BETHEL[allow_edit] will already be set according to admin permissions.
	...
	&& mb_strpos( $_REQUEST['modname'], 'TeacherPrograms' ) === false )
{
	...
	$_BETHEL['allow_edit'] = ( ProgramConfig( 'grades', 'GRADES_TEACHER_ALLOW_EDIT' )
...
if ( GetMP( $_REQUEST['mp'], 'DOES_COMMENTS' ) == 'Y' )
{
	...
	if ( ! empty( $commentsB_select ) && AllowEdit() && ! isset( $_REQUEST['_BETHEL_PDF'] ) )
	{
