...
function SendXMLRequest(subject_id,course)
{
	...
	connection.open("GET","Modules.php?modname=<?php echo $_REQUEST['modname']; ?>&_BETHEL_PDF=true&modfunc=XMLHttpRequest&subject_id=" + subject_id + "&course_title=" + encodeURIComponent(course), true );
