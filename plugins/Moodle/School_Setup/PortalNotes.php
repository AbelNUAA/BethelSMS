...
function core_notes_create_notes_object()
{
	...
	$userid = MoodleXBETHELGet( 'staff_id', User( 'STAFF_ID' ) );
...
function core_notes_create_notes_response( $response )
{
	...
	//then, save the ID in the moodlexBETHEL cross-reference table if no error:
	/*
	list of (
	object {
...
function core_notes_delete_notes_object()
{
	...
	$noteid = MoodleXBETHELGet( 'portal_note_id', $_REQUEST['id'] );
...
function core_notes_delete_notes_response( $response )
{
	...
	//then, delete the ID in the moodlexBETHEL cross-reference table if no error:
	/*
...
function core_notes_update_notes_object()
{
	...
	//gather the Moodle note ID
	$BETHEL_id = $id;
	$moodle_id = MoodleXBETHELGet( 'portal_note_id', $BETHEL_id );
