...
function core_course_create_courses_object()
{
	...
	$categoryid = MoodleXBETHELGet( 'course_id', $rolled_course_period['COURSE_ID'] );
...
function core_role_assign_roles_object()
{
	...
	$userid = MoodleXBETHELGet( 'staff_id', $rolled_course_period['TEACHER_ID'] );
	...
	$courseid = MoodleXBETHELGet( 'course_period_id', $rolled_course_period['COURSE_PERIOD_ID'] );
...
function core_role_unassign_roles_object()
{
	...
	$userid = MoodleXBETHELGet( 'staff_id', $cp_teacher_id );
