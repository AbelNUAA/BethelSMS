...
function core_user_update_users_object()
{
	...
	$moodle_id = MoodleXBETHELGet( 'staff_id', UserStaffID() );
...
function core_role_assign_roles_object()
{
	...
	//gather the Moodle user ID
	$userid = MoodleXBETHELGet( 'staff_id', ( ! empty( $staff_id ) ? $staff_id : UserStaffID() ) );
...
function core_role_unassign_roles_object()
{
	...
	//gather the Moodle user ID
	$userid = MoodleXBETHELGet( 'staff_id', UserStaffID() );
