 ...
 * Incremental updates
 *
 * Update() function called if BETHEL_VERSION != version in DB
 *
 * @package BETHELSIS
...
function Update()
{
	...
	$to_version = BETHEL_VERSION;

	/**
	 * Check if Update() version < BETHEL_VERSION.
	 *
	 ...
	 */
	if ( version_compare( '8.0.2', BETHEL_VERSION, '<' ) )
	{
		return false;
	}
