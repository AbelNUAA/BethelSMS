 ...
 * From: BETHELSIS <BETHELsis@yourdomain.com>
 *
...
function SendEmail( $to, $subject, $message, $reply_to = null, $cc = null, $attachments = array() )
{
	...
	{
		// Set Email address to send from: BETHELSIS <BETHELsis@yourdomain.com>.
...
// Old function.
// $from: if empty, defaults to BETHELsis@[yourserverdomain]
// $cc: Carbon Copy, comma separated list of emails
//returns true if email sent, or false

//example:
/*
	if ( filter_var( $BETHELNotifyAddress, FILTER_VALIDATE_EMAIL ) )
	{
		//FJ add SendEmail function
		...
		SendEmail($BETHELNotifyAddress,'Database Error',$message);
	}
*/
