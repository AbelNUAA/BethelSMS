 ...
 *
 * @global array   $_BETHEL       Sets $_BETHEL['Widgets']
...
function Widgets( $item, &$myextra = null )
{
	...
	// Save current widgets list inside $_BETHEL['Widgets'] global var.
	if ( ! isset( $_BETHEL['Widgets'] )
		|| ! is_array( $_BETHEL['Widgets'] ) )
	{
		$_BETHEL['Widgets'] = array();
	}
	...
	switch ( $item )
	{
		...
		case 'all':
			...
			if ( $BETHELModules['Students']
				&& ( empty( $_BETHEL['Widgets']['calendar'] )
					|| empty( $_BETHEL['Widgets']['next_year'] )
					|| empty( $_BETHEL['Widgets']['enrolled'] )
					|| empty( $_BETHEL['Widgets']['rolled'] ) ) )
			{
			...
			// Scheduling.
			if ( $BETHELModules['Scheduling']
				&& empty( $_BETHEL['Widgets']['course'] )
				&& User('PROFILE') == 'admin' )
			{
			...
			if ( $BETHELModules['Attendance']
				&& ( empty( $_BETHEL['Widgets']['absences'] )
					|| empty( $_BETHEL['Widgets']['cp_absences'] ) ) )
			{
			...
			if ( $BETHELModules['Grades']
				&& ( empty( $_BETHEL['Widgets']['gpa'] )
					|| empty( $_BETHEL['Widgets']['class_rank'] )
					|| empty( $_BETHEL['Widgets']['letter_grade'] ) ) )
			{
			...
			if ( $BETHELModules['Eligibility']
				&& ( empty( $_BETHEL['Widgets']['eligibility'] )
					|| empty( $_BETHEL['Widgets']['activity'] ) ) )
			{
			...
			if ( $BETHELModules['Food_Service']
				&& ( empty( $_BETHEL['Widgets']['fsa_balance'] )
					|| empty( $_BETHEL['Widgets']['fsa_discount'] )
					|| empty( $_BETHEL['Widgets']['fsa_status'] )
					|| empty( $_BETHEL['Widgets']['fsa_barcode'] ) ) )
			{
			...
			if ( $BETHELModules['Discipline']
				&& ( empty( $_BETHEL['Widgets']['reporter'] )
					|| empty( $_BETHEL['Widgets']['incident_date'] )
					|| empty( $_BETHEL['Widgets']['discipline_fields'] ) ) )
			{
		...
		case 'user':
			...
			/*$widgets_RET = DBGet( "SELECT TITLE
				...
				( count( $_BETHEL['Widgets'] ) ?
					" AND TITLE NOT IN ('" .
						implode( "','", array_keys( $_BETHEL['Widgets'] ) ) .
					"')" :
					'' )
				);*/
			...
			$saved_widget_titles = array_keys( $_BETHEL['Widgets'] );
		...
		case 'course':
			...
			if ( ! empty( $_REQUEST['w_course_period_id'] ) )
			{
				...
				if ( $_REQUEST['w_course_period_id_which'] === 'subject' )
				{
					...
					{
						$_BETHEL['SearchTerms'] .= '<b>' . _( 'Subject' ) . ': </b>'.
				...
				elseif ( $_REQUEST['w_course_period_id_which'] === 'course' )
				{
					...
					if ( ! $extra['NoSearchTerms'] )
					{
						$_BETHEL['SearchTerms'] .= '<b>' . _( 'Course' ) . ': </b>'.
							( ! empty( $_REQUEST['w_course_period_id_not'] ) ? _( 'Not' ) . ' ' : '' ) .
							$course_title . '<br />';
					}
				}
				...
				else
				{
					...
					if ( ! $extra['NoSearchTerms'] )
					{
						$_BETHEL['SearchTerms'] .= '<b>' . _( 'Course Period' ) . ': </b>' .
							( ! empty( $_REQUEST['w_course_period_id_not'] ) ? _( 'Not' ) . ' ' : '' ) .
		...
		case 'request':
			...
			if ( ! empty( $_REQUEST['request_course_id'] ) )
			{
					...
					|| ! $_REQUEST['missing_request_course'] )
				{
					...
					if ( ! $extra['NoSearchTerms'] )
					{
						$_BETHEL['SearchTerms'] .= '<b>' . _( 'Request' ) . ': </b>' .
							$course[1]['TITLE'] . '<br />';
					}
				}
				// Missing Request.
				else
				{
					...
					if ( ! $extra['NoSearchTerms'] )
					{
						$_BETHEL['SearchTerms'] .= '<b>' . _( 'Missing Request' ) . ': </b>' .
							$course[1]['TITLE'] . '<br />';
					}
				}
			}
		...
		case 'absences':
				...
				&& is_numeric( $_REQUEST['absences_high'] ) )
			{
				...
				if ( ! $extra['NoSearchTerms'] )
				{
					$_BETHEL['SearchTerms'] .= '<b>' . _( 'Days Absent' ) . ' ' . $term . ': </b>' .
						_( 'Between' ) . ' ' .
		...
		case 'cp_absences':
				...
				&& is_numeric( $_REQUEST['w_course_period_id'] ) )
			{
				...
				if ( ! $extra['NoSearchTerms'] )
				{
					$_BETHEL['SearchTerms'] .= '<b>' . _( 'Course Period Absences' ) . ' ' .
						$term . ': </b>' . _( 'Between' ) . ' ' .
						$_REQUEST['cp_absences_low'] . ' &amp; ' .
		...
		case 'class_rank':
				...
				&& is_numeric( $_REQUEST['class_rank_high'] ) )
			{
				...
				if ( ! $extra['NoSearchTerms'] )
				{
					$_BETHEL['SearchTerms'] .= '<b>' . _( 'Class Rank' ) . ' ' . _( 'Between' ) . ': </b>' .
		...
		case 'letter_grade':
			...
			if ( ! empty( $_REQUEST['letter_grade'] ) )
			{
				...
				if ( ! $extra['NoSearchTerms'] )
				{
					$_BETHEL['SearchTerms'] .= $LetterGradeSearchTerms;
				}
		...
		case 'eligibility':
				...
				&& $_REQUEST['ineligible'] == 'Y' )
			{
				...
				if ( ! $extra['NoSearchTerms'] )
				{
					$_BETHEL['SearchTerms'] .= '<b>' . _( 'Eligibility' ) . ': </b>' .
						_( 'Ineligible' ) . '<br />';
				}
			}
		...
		case 'activity':
			...
			if ( ! empty( $_REQUEST['activity_id'] ) )
			{
				...
				if ( ! $extra['NoSearchTerms'] )
				{
					$_BETHEL['SearchTerms'] .= '<b>' . _( 'Activity' ) . ': </b>' .
						$activity_title . '<br />';
				}
			}
		...
		case 'balance':
				...
				&& is_numeric( $_REQUEST['balance_high'] ) )
			{
				...
				if ( ! $extra['NoSearchTerms'] )
				{
					$_BETHEL['SearchTerms'] .= '<b>' . _( 'Student Billing Balance' ) . ' ' . _( 'Between' ) .': </b>' .
		...
		case 'reporter':
			...
			if ( ! empty( $_REQUEST['discipline_reporter'] ) )
			{
				...
				if ( ! $extra['NoSearchTerms'] )
				{
					$_BETHEL['SearchTerms'] .= '<b>' . _( 'Reporter' ) . ': </b>' .
		...
		case 'incident_date':
				...
				&& $discipline_entry_end )
			{
				...
				if ( ! $extra['NoSearchTerms'] )
				{
					$_BETHEL['SearchTerms'] .= '<b>' . _( 'Incident Date' ) . ' ' . _( 'Between' ) . ': </b>' .
			...
			elseif ( $discipline_entry_begin )
			{
				...
				if ( ! $extra['NoSearchTerms'] )
				{
					$_BETHEL['SearchTerms'] .= '<b>' . _( 'Incident Date' ) . ' ' . _( 'On or After' ) . ' </b>' .
			...
			elseif ( $discipline_entry_end )
			{
				...
				if ( ! $extra['NoSearchTerms'] )
				{
					$_BETHEL['SearchTerms'] .= '<b>' . _( 'Incident Date' ) . ' ' . _( 'On or Before' ) . ' </b>' .
						ProperDate( $discipline_entry_end ) . '<br />';
				}
			}
				...
				switch ( $category['DATA_TYPE'] )
				{
					case 'text':
						...
						if ( ! empty( $_REQUEST['discipline'][ $category['ID'] ] ) )
						{
							...
							if ( ! $extra['NoSearchTerms'] )
							{
								$_BETHEL['SearchTerms'] .= '<b>' . $category['TITLE'] . ': </b> ' .
					...
					case 'checkbox':
						...
						if ( ! empty( $_REQUEST['discipline'][ $category['ID'] ] ) )
						{
							...
							if ( ! $extra['NoSearchTerms'] )
							{
								$_BETHEL['SearchTerms'] .= '<b>' . $category['TITLE'] . '</b><br />';
							}
						}
					...
					case 'numeric':
							...
							&& ! empty( $_REQUEST['discipline_end'][ $category['ID'] ] ) )
						{
							...
							if ( ! $extra['NoSearchTerms'] )
							{
								$_BETHEL['SearchTerms'] .= '<b>' . $category['TITLE'] . ' ' . _( 'Between' ) . ': </b>' .
									$discipline_begin . ' &amp; ' .
									$discipline_end . '<br />';
							}
						}
		...
		case 'next_year':
				...
				&& $_REQUEST['next_year'] !== '' ) // Handle "Retain" case: value is '0'.
			{
				...
				if ( ! $extra['NoSearchTerms'] )
				{
					$_BETHEL['SearchTerms'] .= '<b>' . _( 'Next Year' ) . ': </b>' .
		...
		case 'calendar':
			...
			if ( ! empty( $_REQUEST['calendar'] ) )
			{
				...
				if ( ! $extra['NoSearchTerms'] )
				{
					$_BETHEL['SearchTerms'] .= '<b>' . _( 'Calendar' ) . ': </b>' . $text_not . '<br />';
				}
			}
		...
		case 'enrolled':
				...
				&& $enrolled_end )
			{
				...
				if ( ! $extra['NoSearchTerms'] )
				{
					$_BETHEL['SearchTerms'] .= '<b>' . _( 'Enrolled' ) . ' ' . _( 'Between' ) . ': </b>' .
			...
			elseif ( $enrolled_begin )
			{
				...
				if ( ! $extra['NoSearchTerms'] )
				{
					$_BETHEL['SearchTerms'] .= '<b>' . _( 'Enrolled' ) . ' ' . _( 'On or After' ) . ': </b>' .
			...
			elseif ( $enrolled_end )
			{
				...
				if ( ! $extra['NoSearchTerms'] )
				{
					$_BETHEL['SearchTerms'] .= '<b>' . _( 'Enrolled' ) . ' ' . _( 'On or Before' ) . ': </b>' .
						ProperDate( $enrolled_end ) . '<br />';
				}
			}
		...
		case 'rolled':
			...
			if ( ! empty( $_REQUEST['rolled'] ) )
			{
				...
				if ( ! $extra['NoSearchTerms'] )
				{
					$_BETHEL['SearchTerms'] .= '<b>' . _( 'Previously Enrolled' ) . ': </b>' .
		...
		case 'fsa_discount':
			...
			if ( ! empty( $_REQUEST['fsa_discount'] ) )
			{
				...
				if ( ! $extra['NoSearchTerms'] )
				{
					$_BETHEL['SearchTerms'] .= '<b>' . _( 'Food Service Discount' ) . ': </b>' .
		...
		case 'fsa_status':
			...
			if ( ! empty( $_REQUEST['fsa_status'] ) )
			{
				...
				if ( ! $extra['NoSearchTerms'] )
				{
					$_BETHEL['SearchTerms'] .= '<b>' . _( 'Account Status' ) . ': </b>' .
		...
		case 'fsa_account_id':
				...
				&& is_numeric( $_REQUEST['fsa_account_id'] ) )
			{
				...
				if ( ! $extra['NoSearchTerms'] )
				{
					$_BETHEL['SearchTerms'] .= '<b>' . _( 'Food Service Account ID' ) . ': </b>' .
		...
		case 'medical_date':
				...
				&& $medical_end )
			{
				...
				if ( ! $extra['NoSearchTerms'] )
				{
					$_BETHEL['SearchTerms'] .= '<b>' . $medical_type_label . ' ' . _( 'Between' ) . ': </b>' .
			...
			elseif ( $medical_begin )
			{
				...
				if ( ! $extra['NoSearchTerms'] )
				{
					$_BETHEL['SearchTerms'] .= '<b>' . $medical_type_label . ' ' . _( 'On or After' ) . ' </b>' .
			...
			elseif ( $medical_end )
			{
				...
				if ( ! $extra['NoSearchTerms'] )
				{
					$_BETHEL['SearchTerms'] .= '<b>' . $medical_type_label . ' ' . _( 'On or Before' ) . ' </b>' .
						ProperDate( $medical_end ) . '<br />';
				}
			}
