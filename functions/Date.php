 ...
 *
 * @global array   $_BETHEL Sets $_BETHEL['PrepareDate']
 *
...
function PrepareDate( $date, $name_attr = '', $allow_na = true, $options = array() )
{
	...
	$_BETHEL['PrepareDate'] = isset( $_BETHEL['PrepareDate'] ) ?
		++$_BETHEL['PrepareDate'] :
		1;
	...
	if ( $options['M'] )
	{
		$return_m .= '<select name="month' . $name_attr . '" id="monthSelect' . $_BETHEL['PrepareDate'] . '"' .
		...
		$return_m .= '<label for="monthSelect' . $_BETHEL['PrepareDate'] . '" class="a11y-hidden">' .
			_( 'Month' ) . '</label>';
	}
	...
	if ( $options['D'] )
	{
		$return_d .= '<select name="day' . $name_attr . '" id="daySelect' . $_BETHEL['PrepareDate'] . '"' .
		...
		$return_d .= '<label for="daySelect' . $_BETHEL['PrepareDate'] . '" class="a11y-hidden">' .
			_( 'Day' ) . '</label>';
	}
	...
	if ( $options['Y'] )
	{
		...
		$return_y .= '<select name="year' . $name_attr . '" id="yearSelect' . $_BETHEL['PrepareDate'] . '"' .
		...
		$return_y .= '<label for="yearSelect' . $_BETHEL['PrepareDate'] . '" class="a11y-hidden">' .
			_( 'Year' ) . '</label>';
	}
	...
	if ( $options['C'] )
	{
		$return .= '<img src="assets/themes/' . Preferences( 'THEME' ) . '/btn/calendar.png" title="' . _( 'Open calendar' ) . '" class="button cal" alt="' . _( 'Open calendar' ) . '" id="trigger' . $_BETHEL['PrepareDate'] . '" />';
	}
